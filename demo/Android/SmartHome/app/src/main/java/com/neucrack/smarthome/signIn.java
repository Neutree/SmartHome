...
public class signIn extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPhonelView = (AutoCompleteTextView) findViewById(R.id._userName);
        populateAutoComplete();

        mPasswordView = (EditText) findViewById(R.id._userPassword);
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id._sign_in_button);
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(phone)) {
            mPhonelView.setError(getString(R.string.error_field_required));
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        mPhonelView.setAdapter(adapter);
    }
