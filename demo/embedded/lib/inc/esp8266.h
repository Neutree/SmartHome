...
class esp8266
{
	...
	bool CreateTCPMutipleMode(unsigned char muxID,char* ipAddr,short port,Socket_Type socketType);
	bool SendMultipleMode(unsigned char muxID,char* data, unsigned int num);
